...
"use strict";
    ...
    PaymentForm.include({
        ...
        changeMultiSafepayAcquirerStatus: function () {
            ...
            if (checked_radio[0].getAttribute('data-ideal-issuer') == 'true' && typeof cc_select !== 'undefined') {
                cc_select.setAttribute('hidden', '');
                ideal_select.removeAttribute('hidden');
            } else if (checked_radio[0].getAttribute('data-credit-card') == 'true'  && typeof ideal_select !== 'undefined') {
